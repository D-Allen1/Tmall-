    ...
    <div class="classify">
        ...
        <div class="main" :style="{height:mainHeight}">
            ...
            <div class="mainLeft wrapper" ref="wrapper">
                <div class="content">
                    <div class="item" :class="currentIndex == index ?
                    'item_on' : ''" v-for="(item,index) in menuTitle" :key="item.id"
                    @click="menuClick(index)">{{item.name}}</div>
                </div>
            </div>
            <!-- 主体右侧 -->
            <div class="marinRight wrapper" ref="wrapper2">
                <div class="content">
                    <!-- 顶部图 -->
                    ...
                    <!-- 内容 -->
                    <div class="container" v-for="(item,index) in 
                    menuDetail.details" :key="index">
